                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <?php 
                                $query4 = mysqli_query($con, "SELECT * FROM teachers");
                                $totalteachers = mysqli_num_rows($query4);
                                ?>
                                <div class="inner">
                                ...
                                <a href="manage_teachers.php" class="small-box-footer">Manage Teachers <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                    </div>
